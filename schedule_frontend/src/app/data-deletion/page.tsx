...
export const metadata: Metadata = {
  title: "Data Deletion — Schedulr",
  description:
    "How to disconnect Schedulr, revoke Google access, and remove locally held session data.",
};
...
export default function DataDeletionPage() {
  return (
    <LegalPage
      ...
      introduction="Schedulr does not maintain user accounts or intentionally persist uploaded schedules in its own database."
    >
      <section>
        <h2>Disconnect from the setup page</h2>
        <p className="mt-3">
          Select <strong>Disconnect</strong> in the Schedulr setup-page header.
          Schedulr attempts to revoke the active Google access token and deletes
      ...
      <section>
        ...
        <p className="mt-3">
          ...
          , find Schedulr, and remove its access. This invalidates any remaining
      ...
      <section>
        ...
        <p className="mt-3">
          The encrypted Schedulr session cookie expires in about one hour.
      ...
      <section>
        ...
        <p className="mt-3">
          Schedulr may retain the minimum technical or pseudonymous information
      ...
      <section>
        ...
        <p className="mt-3">
          ...
          on Schedulr&apos;s Google OAuth consent screen. General questions can
          ...
          <a
            ...
            target="_blank"
          >
            Schedulr project support tracker
          </a>
