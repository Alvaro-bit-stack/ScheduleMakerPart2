...
export const metadata: Metadata = {
  ...
  description:
    "How CalSnap collects, uses, protects, retains, and deletes schedule and Google Calendar data.",
};
...
export default function PrivacyPage() {
  return (
    <LegalPage
      ...
      introduction="This policy explains how CalSnap handles information when you convert a class-schedule image into recurring Google Calendar events."
    >
      <Notice>
        <strong>In short:</strong> CalSnap uses a short-lived Google access token
        to create the events you request. Schedule images are processed by
        Google Cloud Vision and OpenAI. CalSnap does not sell personal
      ...
      <PolicySection title="1. Scope of this policy">
        <p>
          This policy applies to the CalSnap website, its Google Calendar
          connection, and the backend services used to process schedule images.
          In this policy, &quot;CalSnap,&quot; &quot;we,&quot; and
          &quot;our&quot; refer to the operator of the CalSnap service.
        </p>
      </PolicySection>

      <PolicySection title="2. Information CalSnap processes">
        ...
        <ul>
          <li>
            A short-lived Google OAuth access token that permits CalSnap to view
        ...
        <p>
          CalSnap does not request Google profile, email, contacts, Drive, or
          Gmail permissions. CalSnap does not need to read your existing
        ...
        <p>
          ...
          diagnose failures, protect CalSnap, prevent abuse, and administer
          service limits.
        </p>
      </PolicySection>

      <PolicySection title="3. How CalSnap uses information">
        <p>CalSnap processes information only as needed to:</p>
        <ul>
      ...
      <PolicySection title="4. Schedule processing and service providers">
        <p>
          CalSnap uses the following providers to perform the conversion you
          request:
        </p>
        <ul>
          <li>
        ...
        <p>
          CalSnap does not send your Google OAuth token or the contents of your
      ...
      <PolicySection title="5. Google API data and Limited Use">
        <p>
          CalSnap uses information received from Google APIs only to provide the
          user-facing Calendar feature you choose. CalSnap&apos;s use and
        ...
        <p>
          CalSnap does not sell Google user data, use it for advertising,
      ...
      <PolicySection title="6. Cookies and OAuth security">
        <p>
          CalSnap uses strictly necessary cookies to secure the Google
          connection:
        </p>
        <ul>
          <li>
        ...
        <p>
          CalSnap does not request or retain a Google refresh token and does not
      ...
      <PolicySection title="7. One-use-per-four-month allowance">
        <p>
          CalSnap currently permits one successful schedule conversion per
          individual during each rolling four-month period. A successful
          conversion occurs when CalSnap creates at least one requested event in
          Google Calendar. A failed attempt that creates no events does not use
          the allowance.
        </p>
        <p>
          CalSnap does not request Google identity scopes solely to administer
          this limit. Where usage controls are applied, CalSnap may use the
      ...
      <PolicySection title="8. Storage and retention">
        <ul>
          ...
          <li>
            ...
            in a CalSnap application database.
          </li>
          <li>
        ...
        <p>
          CalSnap does not intentionally write OAuth tokens, schedule contents,
      ...
      <PolicySection title="9. Sharing and disclosure">
        <p>
          CalSnap does not sell or rent personal information. Information is
      ...
      <PolicySection title="10. Your choices and deletion">
        <ul>
          <li>
            ...
            active Google token and delete the CalSnap session cookie.
          </li>
          <li>
      ...
      <PolicySection title="11. Security">
        <p>
          CalSnap uses HTTPS in production, OAuth state validation, PKCE,
          ...
          but CalSnap limits the data and authorization it retains.
        </p>
      </PolicySection>

      <PolicySection title="12. Children">
        <p>
          CalSnap is not directed to children under 13, and users under 13 must
          not use the service. If you believe a child has submitted personal
          information, contact CalSnap so the issue can be reviewed.
        </p>
      </PolicySection>

      <PolicySection title="13. Changes to this policy">
        <p>
          This policy may be updated when CalSnap, its providers, or applicable
      ...
      <PolicySection title="14. Contact">
        <p>
          ...
          contact displayed on CalSnap&apos;s Google OAuth consent screen.
